package com.codejam.infrastructure.ratelimit;
...
public class RateLimiterService {
    ...
    public boolean checkRateLimit(String userId) {
        try {
            int maxRequests = microserviceConfig.getGateway().getRateLimit().getMaxRequests();
            long windowDurationSeconds = microserviceConfig.getGateway().getRateLimit().getWindowDurationSeconds();
