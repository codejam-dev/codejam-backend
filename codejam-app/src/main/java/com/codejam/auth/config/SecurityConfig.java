...
public class SecurityConfig {
    ...
    private static final String API_AUTH_PREFIX = "/v1/api/auth";
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(API_AUTH_PREFIX + "/**").permitAll()
                        .requestMatchers("/v1/api/execution/**").permitAll()
                ...
                .oauth2Login(oauth2 -> oauth2
                        .authorizationEndpoint(authorization -> authorization
                                .baseUri(API_AUTH_PREFIX + "/oauth2/authorization")
                                .authorizationRequestResolver(pkceOauth2AuthorizationRequestResolver))
                        .redirectionEndpoint(redirection -> redirection.baseUri(API_AUTH_PREFIX + "/oauth2/callback/*"))
